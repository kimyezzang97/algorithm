package dataStructure.collectionBasic;
...
public class CollectionBasic {
    public static void main(String[] args) {
        ...
        list2.addFirst(10); // linkedList에서는 처음과 끝에 값을 넣을 수 있다.
        list2.addLast(20);
        System.out.println("list2 = " + list2);
        ...
        set2.add(15);
        System.out.println("set2= " + set2);
        System.out.println(set2.first()); // treeSet은 first, last 출력 가능
        System.out.println(set2.last());
        System.out.println("treeSet.lower(11) : " + set2.lower(11));
        System.out.println("treeSet.higher(6) : " + set2.higher(6));
